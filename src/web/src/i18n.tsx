...
const EN: Dict = {
  ...
  "view.settings.eyebrow": "Operations · Settings",
  "view.settings.title": "Settings",
  "view.settings.subtitle":
    "Manage Claw accounts, Dashboard parameters, and Telegram notifications.",
...
const ZH: Dict = {
  ...
  "view.settings.eyebrow": "操作 · 配置",
  "view.settings.title": "配置",
  "view.settings.subtitle": "集中管理 Claw 主账号、Dashboard 参数和 Telegram 通知。",
